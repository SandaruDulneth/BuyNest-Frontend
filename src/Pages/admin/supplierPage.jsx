        ...
        {isLoading ? (
            ...
            <div className="w-full rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
              <table className="min-w-full text-sm md:text-base">
                ...
                <tr>
                  <th className="py-3 px-4 text-xs font-semibold uppercase">Supplier ID</th>
                  ...
                  <th className="py-3 px-4 text-xs font-semibold uppercase">Product ID</th>
                  ...
                  <th className="py-3 px-4 text-xs font-semibold uppercase">Contact No</th>
